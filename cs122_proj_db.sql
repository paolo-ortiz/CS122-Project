...
CREATE TABLE Grade(StudentID int, RequirementID varchar(255), Grade int,  PRIMARY KEY(StudentID, RequirementID), 
		FOREIGN KEY(StudentID) References Student(TeacherID), 
		FOREIGN KEY (RequirementID) REFERENCES Requirement(SectionName));
