<?php 
    ...
    if(isset($_POST['submit'])) {
        ...
        if(empty($_POST['subjectID'])) {
            $errors['subjectID'] = 'SubjectID is required';
        } else {
            $section = htmlspecialchars($_POST['subjectID']);
        }
        ...
        if(array_filter($errors)) {
            ...
            //create sql
            $sql = "INSERT INTO section(sectionName) VALUES( '$section')";
            $sql2 = "INSERT INTO subject(subjectID, name) VALUES( '$subjectID','$subject')";
